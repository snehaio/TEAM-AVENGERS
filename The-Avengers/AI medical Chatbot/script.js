...
const API_KEY = "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";
...
class Chat {
  ...
  async botResponse(user_text) {
    ...
    try {
      ...
      console.log(error);
      addChatMessage(
        "Sorry but we are facing some technical issues right now, Try again later.",
        true
      );
    }
  }
